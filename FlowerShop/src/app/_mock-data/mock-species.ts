...
export const SPECIES: Specie[] = [
    ...
    {specie: 'rose', type: 'yellow-rose', sunNeeds: 'Full Sun', soilNeeds: 'Well-drained', bloomsIn: 'Late Spring - Early Fall'},
    {specie: 'rose', type: 'blue-rose', sunNeeds: 'Full Sun', soilNeeds: 'Well-drained', bloomsIn: 'Late Spring - Early Fall'},
